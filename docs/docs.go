    ...
    "paths": {
        ...
        "/couples/confirm": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Confirmation request with couple ID",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/couples/invite": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Invite request with partner's invite key",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "handlers.RegisterResponse": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "Vui lòng kiểm tra email để xác nhận tài khoản."
                },
                "success": {
                    "type": "boolean",
                    "example": true
        ...
        "shared.CoupleStatus": {
            ...
            "x-enum-varnames": [
                "CoupleStatusPendingInvitation",
                "CoupleStatusActive",
                "CoupleStatusGracePeriod",
                "CoupleStatusEnded"
            ]
        },
        "shared.Gender": {
